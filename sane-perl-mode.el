...
See documentation of a variable `sane-perl-problems-old-emaxen' for the
problems which disappear if you upgrade Emacs to a reasonably new
version (20.3 for Emacs).")

(defvar sane-perl-problems-old-emaxen 'please-ignore-this-line
  "Description of problems in Sane-Perl mode specific for older Emacs versions.
...
properties.  Patches are available on the main Sane-Perl download site,
and on CPAN.
...
via `sane-perl-use-syntax-table-text-property'.")

(defvar sane-perl-praise 'please-ignore-this-line
  "Advantages of Sane-Perl mode.
...
(defvar sane-perl-speed 'please-ignore-this-line
  "This is an incomplete compendium of what is available in other parts
of Sane-Perl documentation.  (Please inform me if I skipped anything.)

There is a perception that Sane-Perl is slower than alternatives.  This part
of documentation is designed to overcome this misconception.

*By default* Sane-Perl tries to enable the most comfortable settings.
From most points of view, correctly working package is infinitely more
comfortable than a non-correctly working one, thus by default Sane-Perl
prefers correctness over speed.  Below is the guide how to change
settings if your preferences are different.

A)  Speed of loading the file.  When loading file, Sane-Perl may perform a
...
syntax-parsing routines, and marks them up so that either
    ...
    A1) Sane-Perl may work around these deficiencies (for big chunks, mostly
        PODs and HERE-documents), or
    A2) On capable Emaxen Sane-Perl will use improved syntax-handling
...
B) Speed of editing operations.
    ...
    constructs be wrongly recognized by Sane-Perl, thus may lead to
    wrongly matched parentheses, wrong indentation, etc.

    One can unset `sane-perl-syntaxify-unwind'.  This might speed up editing
    of, say, long POD sections.")

(defvar sane-perl-tips-faces 'please-ignore-this-line
  "Sane-Perl mode uses following faces for highlighting:
