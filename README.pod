...
merits being highlighted in an exaggerated way, and the underscores
were also misleading. For example, after a dollar the underscore would
...
the Emacs lisp of this module so far, it's not clear who the opinions
belonged to, and it doesn't make sense to keep them in a module
maintained by other people who may not share the opinions.
